...
from Fountain_analyzer import FT_Analyzer_Simplified
...
# -------------------------- encoding ------------------------------------ #
st.header('SOS-DNA: an error Simulation and Optimization System for DNA data storage')
st.markdown('In this demonstrative web app for SOS-DNA, you will encode lena.jpg to DNA with DNA fountain code,\
